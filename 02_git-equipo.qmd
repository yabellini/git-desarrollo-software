...
Así que cada vez haces un push, git comparará los archivos en el repositorio 
remoto con la versión que actualizaste localmente y actualizará el repo remoto para
que todo esté sincronizado. Ademas vos tenes permiso totales sobre ambos repositorios, pero cuando colaboras en un proyecto, puedes encontrarte en una de estas dos situaciones

- Tienes permiso de escritura en el repositorio en el que estás trabajando.
- No tienes permiso de escritura en el repositorio.

## Branches (ramas) y Pull Request (solicitudes de cambios)

Antes de seguir con el flujo de trabajo colaborativo, es importante entender dos conceptos de git: ramas y pull requests.
...
### Escenario 1: Tienes permiso de escritura en el repositorio en el que estás trabajando.
...
La única diferencia entre esto y trabajar por tu cuenta es que necesitas comunicarte bien para que dos personas no trabajen en lo mismo.
Pero esto es así con o sin git.
...
## Escenario 2 - No tienes permiso de escritura en el repositorio.
